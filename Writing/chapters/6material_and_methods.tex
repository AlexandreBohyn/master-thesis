...
\begin{equation}
	...
	\text{.}    
\end{equation}
This formulation demonstrates the equivalence between the semi-variogram, the DEC model and the $AR(1) \times AR(1)$ process for field experiments. Figure \ref{} show an example of a simulated variogram using an $AR(1) \times AR(1)$ process and actual variogram fitted using the same process.
