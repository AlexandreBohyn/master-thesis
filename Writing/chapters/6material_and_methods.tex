...
\begin{table}[ht]
\centering
\caption{Germination rate and mean seed weight for each genotype used. (there is no data concerning the germination rate of the 
...
\caption{Bilinear and smooth components of the PS-ANOVA decomposition of the estimated spatial trend for the barley uniformity
...
Therefore, using this new notation, model \ref{eq:smooth_part_only_model} only containing a smooth bivariate surface and an error term can be rewritten in the following way:
...
%%	\caption{Diagram detailing the structure of the matrices used in this section.}
