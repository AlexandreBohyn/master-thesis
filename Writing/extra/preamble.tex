...
\usepackage[table]{xcolor} %the table option allows us to alternate coloring in table rows
...
%New command to get a clear page (for the cover page)
\newcommand\blankpage{%
    \null
    \thispagestyle{empty}%
    \addtocounter{page}{-1}%
...
% Command and package to make a "formal" environment 
%to have note inside the text.
